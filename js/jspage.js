...
//svg sets
    var articleSVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" enable-background="new 0 0 60 60"><path d="M47 32c-7.168 0-13 5.832-13 13s5.832 13 13 13 13-5.832 13-13-5.832-13-13-13zm0 24c-6.065 0-11-4.935-11-11s4.935-11 11-11 11 4.935 11 11-4.935 11-11 11zM53 44h-5v-5c0-.553-.448-1-1-1s-1 .447-1 1v5h-5c-.552 0-1 .447-1 1s.448 1 1 1h5v5c0 .553.448 1 1 1s1-.447 1-1v-5h5c.552 0 1-.447 1-1s-.448-1-1-1zM42 0h-24c-9.925 0-18 8.068-18 17.985v14c0 9.59 7.538 17.452 17 17.973v8.344c0 .936.764 1.698 1.703 1.698.449 0 .873-.177 1.195-.498l1.876-1.877c2.967-2.967 6.547-5.132 10.493-6.388-.815-1.918-1.267-4.025-1.267-6.237 0-8.822 7.178-16 16-16 5.161 0 9.746 2.467 12.673 6.271.204-1.08.327-2.175.327-3.286v-14c0-9.917-8.075-17.985-18-17.985z"/></svg>';
    var topicSVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" enable-background="new 0 0 60 60"><path d="M33 57h24v-24h-24v24zm2-22h20v20h-9v-12.586l4.293 4.293 1.414-1.414-6.707-6.707-6.707 6.707 1.414 1.414 4.293-4.293v12.586h-9v-20zM42 0h-24c-9.925 0-18 8.068-18 17.985v14c0 9.59 7.538 17.452 17 17.973v8.344c0 .936.764 1.698 1.703 1.698.449 0 .873-.177 1.195-.498l1.876-1.877c2.388-2.388 5.173-4.257 8.226-5.552v-22.073h30v-12.015c0-9.917-8.075-17.985-18-17.985z"/></svg>';
    var answerSVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" enable-background="new 0 0 60 60"><path d="M52.179 40.429l-5.596 8.04-3.949-3.241c-.426-.352-1.057-.287-1.407.138-.351.427-.289 1.058.139 1.407l4.786 3.929c.18.148.404.228.634.228l.137-.01c.276-.038.524-.19.684-.419l6.214-8.929c.315-.453.204-1.076-.25-1.392-.454-.32-1.076-.205-1.392.249zM47 32c-7.168 0-13 5.832-13 13s5.832 13 13 13 13-5.832 13-13-5.832-13-13-13zm0 24c-6.065 0-11-4.935-11-11s4.935-11 11-11 11 4.935 11 11-4.935 11-11 11zM42 0h-24c-9.925 0-18 8.068-18 17.985v14c0 9.59 7.538 17.452 17 17.973v8.344c0 .936.764 1.698 1.703 1.698.449 0 .873-.177 1.195-.498l1.876-1.877c2.967-2.967 6.547-5.132 10.493-6.388-.815-1.918-1.267-4.025-1.267-6.237 0-8.822 7.178-16 16-16 5.161 0 9.746 2.467 12.673 6.271.204-1.08.327-2.175.327-3.286v-14c0-9.917-8.075-17.985-18-17.985z"/></svg>';
    var commentSVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" enable-background="new 0 0 60 60"><path d="M53.279 32.604c-1.128-1.129-3.094-1.129-4.222 0l-15.39 15.391-2.122 7.779-.519.519c-.388.388-.389 1.014-.006 1.405l-.005.02.019-.005c.195.19.447.287.699.287.256 0 .512-.098.707-.293l.52-.52 7.778-2.121 15.391-15.391c1.163-1.164 1.163-3.058 0-4.222l-2.85-2.849zm-17.303 15.911l10.243-10.243 4.243 4.243-10.243 10.243-4.243-4.243zm-.903 1.925l3.22 3.22-4.428 1.208 1.208-4.428zm19.642-12.178l-2.839 2.839-4.243-4.243 2.839-2.839c.372-.373 1.021-.373 1.394 0l2.849 2.85c.384.383.384 1.009 0 1.393zM42 0h-24c-9.925 0-18 8.068-18 17.985v14c0 9.59 7.538 17.452 17 17.973v8.344c0 .936.764 1.698 1.703 1.698.449 0 .873-.177 1.195-.498l1.876-1.877c2.22-2.22 4.789-3.978 7.591-5.257l1.618-5.931 15.954-15.954c1.131-1.131 2.634-1.753 4.232-1.753s3.102.622 4.232 1.753l2.85 2.85c.643.643 1.091 1.402 1.379 2.206.238-1.166.37-2.352.37-3.554v-14c0-9.917-8.075-17.985-18-17.985z"/></svg>';
        ...
        if (userActivity.readyState === 4)
            {
                 ...
                 for (var i = 0; i < userActivitys.length; i++) {
                     ...
                     if (userActivitys[i].icon === 'article') {
                        userActivityList +=  articleSVG; 
                     }else if(userActivitys[i].icon === 'answer'){
                        userActivityList +=  answerSVG;
                     }else if(userActivitys[i].icon === 'startTopic'){
                        userActivityList +=  topicSVG;
                     }else if(userActivitys[i].icon === 'comment'){
                        userActivityList +=  commentSVG;
                     };
                     userActivityList += '</div>';
